            ...
            <div class="col-sm-3">
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input class="form-control" type="text" name="diachixuatkho" placeholder="Địa chỉ nhập hàng..." required/>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                ...
                                <input class="form-control" id="search_product_storage" placeholder="Nhập sản phẩm cần tìm ...." />
