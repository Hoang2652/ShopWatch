...
<form class="formxulynhapxuat" action="" method="post" enctype="multipart/form-data" name="frm" onsubmit="return kiemtrahoadonnhapxuat()">
    <div class="add__sp">
        ...
        <div class="form-row mb-3">
            <div class="col-md-6">
				<label for="diachinhapkho">Địa chỉ xuất kho: </label>
                <br />	
        ...
        {{-- <div id='replaceButton'>
            <input type="text" class="form-control" id="timkiem-sanphamtonkho" name="timkiem" placeholder="Nhập id hóa đơn" onkeyup="livesreachxuatkho(this.value,0)">
        </div>
        <div id='livesreach-warehouse'></div> --}}
...
<script>
// $('#timkiem-sanphamtonkho').keyup(function(){
//     var query= $(this).val();
//     if(query.toString().length == 0){
//         document.getElementById("livesreach-warehouse").innerHTML = "";
//         return;
//     }
//     else{
//         $.ajax({
...
//             $('#livesreach-warehouse').html(data);
//         }
//         }); 
//     }
// });
